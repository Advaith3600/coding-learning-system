...
type Student = { id: string; username: string; email: string };
  ...
  return (
    <main className="container-app py-10">
      <div className="flex flex-wrap items-end justify-between gap-4">
        ...
        <a href="/admin/dashboard" className="btn btn-secondary h-control-md px-4">
          Back to dashboard
        </a>
      </div>
      ...
      <div className="card mt-6 p-5">
        ...
        <button type="button" disabled={busy} onClick={create} className="btn btn-primary mt-4">
          Create
        </button>
      </div>
